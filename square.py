...
#loss 改成自己的 my_own_loss
    ...
    def margin_and_loss(self, x, y):
        ...
        if self.loss == 'ce':
                ...
                print(y_corr - y_others, y_corr - y_others)
                return y_corr - y_others, y_corr - y_others
        elif self.loss == 'my_own_loss':
            print("running my_own_loss")
            print(y_corr - y_others, y_corr - y_others)
            return y_corr - y_others, y_corr - y_others
    ...
    def init_hyperparam(self, x):
        ...
        assert self.loss in ['ce', 'margin','my_own_loss']
